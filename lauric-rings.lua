...
gauge = {
{
    ...
    graph_bg_colour=0xff0000,      graph_bg_alpha=0.1,
    graph_fg_colour=0xff0000,      graph_fg_alpha=0.2,
    hand_fg_colour=0xff0000,       hand_fg_alpha=0.2,
    txt_radius=20,
    txt_weight=1,                  txt_size=60,
...
},
{
    ...
    graph_bg_colour=0x0088ff,      graph_bg_alpha=0.1,
    graph_fg_colour=0x0088ff,      graph_fg_alpha=0.2,
    hand_fg_colour=0x0088ff,       hand_fg_alpha=0.2,
    txt_radius=100,
    txt_weight=1,                  txt_size=60,
    txt_fg_colour=0x0088ff,        txt_fg_alpha=0.6,
    graduation_radius=0,
    graduation_thickness=0,        graduation_mark_thickness=1,
    graduation_unit_angle=0,
    graduation_fg_colour=0xffffff, graduation_fg_alpha=0.3,
    ...
    caption_fg_colour=0x0088ff,    caption_fg_alpha=0.6,
},
{
    name='hwmon  temp 1',                    arg='',                  max_value=100,
    x=148,                         y=455,
    graph_radius=50,
    graph_thickness=10,
    graph_start_angle=250,
    graph_unit_angle=1.9,         graph_unit_thickness=2.7,
    graph_bg_colour=0xff0000,      graph_bg_alpha=0.1,
    graph_fg_colour=0xFF0000,      graph_fg_alpha=0.2,
    hand_fg_colour=0xff0000,       hand_fg_alpha=0.2,
    txt_radius=50,
...
},
{
    ...
    graph_thickness=10,
    graph_start_angle=270,
    graph_unit_angle=1.60,         graph_unit_thickness=2.7,
    graph_bg_colour=0xff0000,      graph_bg_alpha=0.1,
    graph_fg_colour=0xFF0000,      graph_fg_alpha=0.2,
    hand_fg_colour=0xff0000,       hand_fg_alpha=0.2,
    txt_radius=20,
...
},
{
    ...
    graph_fg_colour=0x00ff00,      graph_fg_alpha=0.2,
    hand_fg_colour=0x00ff00,       hand_fg_alpha=0.2,
    txt_radius=100,
    txt_weight=1,                  txt_size=60,
    txt_fg_colour=0x00ff00,        txt_fg_alpha=0.6,
    graduation_radius=0,
    graduation_thickness=0,        graduation_mark_thickness=1,
    graduation_unit_angle=0,
    graduation_fg_colour=0xffffff, graduation_fg_alpha=0.3,
    caption='',
    caption_weight=1,              caption_size=20.0,
    caption_fg_colour=0x00ff00,    caption_fg_alpha=0.6,
},
{
    ...
    hand_fg_colour=0xffff00,       hand_fg_alpha=0.3,
    txt_radius=30,
    ...
    caption='            SWAP',
    caption_weight=1,              caption_size=10.0,
    caption_fg_colour=0xffff00,    caption_fg_alpha=0.6,
},
}
